...
ax.legend()
ax.set_title('s='+str(s)+' f='+str(f)+' sand='+str(0.4)+' clay='+str(0.3)+' bulk='+str(1.65)+' d='+str(d)+' mv='+str(0.2)+' ke='+str(ke))
...
# ax.set_xlim(0.,70.)
# ax.set_ylim(-17.,-9.)
plt.savefig('/media/tweiss/Daten/plots/sensitivity/theta')
plt.close()
plt.show()

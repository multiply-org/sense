...
Ref= core.Reflectivity(eps=eps, theta=theta)
#Ref._calc_reflection_coefficients()
Ref.plot()

#stype = 'rayleigh'
##stype='turbid_isotropic'
#models = {'surface': 'Oh92', 'canopy': stype}
#T= model.CanopyHomoRT(surface=soil, canopy=can, models=models, theta=theta, freq=freq)
